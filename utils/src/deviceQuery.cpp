...
// template function
template <typename T> inline void getCudaAttribute(T *attribute, CUdevice_attribute device_attribute, int device)
{
...
{
    printf("Getting device infomation...");
